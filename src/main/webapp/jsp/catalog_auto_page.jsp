...
<body>
	...
	<div>
		<div
			...
			<form action="Controller" method="GET">
				<input type="hidden" value="sort_auto" name="command" />
				...
				<div style="margin-bottom: 20px;">
					Fuil type
					<div>
						<td><input type="checkbox" name="fuil_type" value="petrol" />petrol</td>
					</div>
					<div>
						<td><input type="checkbox" name="fuil_type" value="diesel" />diesel</td>
					</div>
					<div>
						<td><input type="checkbox" name="fuil_type" value="gas" />gas</td>
					</div>
					<div>
						<td><input type="checkbox" name="fuil_type" value="electro" />electro</td>
					</div>
				</div>
				<div>
		...
		<div style="background: #f2f2f2">
			<form action="Controller" method="GET">
				...
				<div style="margin-bottom: 30px;">
					<table border="1">
						<c:forEach items="${list_auto}" var="i">
							<tr>
