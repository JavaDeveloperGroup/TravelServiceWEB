...
<body>
	...
	<div>
		<div
			...
			<form action="Controller" method="GET">
				<input type="hidden" value="sort_tour" name="command" />
				...
				<div style="margin-bottom: 20px;">
					<div>
						<td><input type="checkbox" name="max_price" value="70" />3 stars</td>
					</div>
					<div>
						<td><input type="checkbox" name="max_price" value="100" />4 stars</td>
					</div>
					<div>
						<td><input type="checkbox" name="max_price" value="150" />5 stars</td>
					</div>
				</div>
				<div>
		...
		<div style="background: #f2f2f2">
			<form action="Controller" method="GET">
				...
				<div style="margin-bottom: 30px;">
					<table border="1">
						<c:forEach items="${list_tour}" var="i">
							<tr>
