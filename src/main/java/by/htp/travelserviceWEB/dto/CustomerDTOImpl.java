...
public class CustomerDTOImpl implements Serializable, Customer {
	...
	public CustomerDTOImpl(String login, String password, String name, String surname, String gender,
